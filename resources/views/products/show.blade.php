    ...
    <div class="container-menu py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div>
                    ...
                    <div class="flex items-center p-4">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-lime-600">
                                Se hacen envíos solo a la península
                            </p>
                ...
                <!--
                    Aquí, depende de si el producto tiene color, color y talla o ninguna,
                    saldrá una vista u otra. La vista es el número de stock y los botones
                    de sumar cantidad y de añadir al carrito
                -->
